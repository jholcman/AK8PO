...
namespace AK8PO {
    ...
    public partial class DatabaseUTBDataSet21 : global::System.Data.DataSet {
        ...
        public partial class PredmetDataTable : global::System.Data.TypedTableBase<PredmetRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PredmetRow AddPredmetRow(int Id, string zkratka, int velikost_tridy, string nazev_predmetu, int počet_kreditu) {
...
namespace AK8PO.DatabaseUTBDataSet21TableAdapters {
    ...
    public partial class PredmetTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Predmet] WHERE (([Id] = @Original_Id) AND ([zkratka] = @Original_zkratka) AND ([velikost_tridy] = @Original_velikost_tridy) AND ((@IsNull_nazev_predmetu = 1 AND [nazev_predmetu] IS NULL) OR ([nazev_predmetu] = @Original_nazev_predmetu)) AND ([počet_kreditu] = @Original_počet_kreditu))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Predmet] SET [Id] = @Id, [zkratka] = @zkratka, [velikost_tridy] = @velikost_tridy, [nazev_predmetu] = @nazev_predmetu, [počet_kreditu] = @počet_kreditu WHERE (([Id] = @Original_Id) AND ([zkratka] = @Original_zkratka) AND ([velikost_tridy] = @Original_velikost_tridy) AND ((@IsNull_nazev_predmetu = 1 AND [nazev_predmetu] IS NULL) OR ([nazev_predmetu] = @Original_nazev_predmetu)) AND ([počet_kreditu] = @Original_počet_kreditu));
SELECT Id, zkratka, velikost_tridy, nazev_predmetu, počet_kreditu FROM Predmet WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, zkratka, velikost_tridy, nazev_predmetu, počet_kreditu FROM dbo.Predme" +
                "t";
        ...
        public virtual int Delete(int Original_Id, string Original_zkratka, int Original_velikost_tridy, string Original_nazev_predmetu, int Original_počet_kreditu) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_počet_kreditu));
        ...
        public virtual int Update(int Id, string zkratka, int velikost_tridy, string nazev_predmetu, int počet_kreditu, int Original_Id, string Original_zkratka, int Original_velikost_tridy, string Original_nazev_predmetu, int Original_počet_kreditu) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(počet_kreditu));
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_počet_kreditu));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string zkratka, int velikost_tridy, string nazev_predmetu, int počet_kreditu, int Original_Id, string Original_zkratka, int Original_velikost_tridy, string Original_nazev_predmetu, int Original_počet_kreditu) {
            return this.Update(Original_Id, zkratka, velikost_tridy, nazev_predmetu, počet_kreditu, Original_Id, Original_zkratka, Original_velikost_tridy, Original_nazev_predmetu, Original_počet_kreditu);
        }
    }
